...
import com.lookalike.admin.config.auth.dto.OAuthAttributes;
import com.lookalike.admin.config.auth.dto.SessionUser;
import com.lookalike.admin.domain.user.User;
import com.lookalike.admin.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        //지금은 구글만 사용하는 불필요한 값이지만, 네이버 로그인 연동 시에 네이버 로그인인지
        //,구글 로그인인지 구분하기 위해 사용된다
